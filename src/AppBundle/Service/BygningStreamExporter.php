...
class BygningStreamExporter
{
    ...
    {
        if ('tiltag' === $this->type && $bygning->getRapport() && $bygning->getRapport()->getTiltag()) {
    ...
    private function writeHeader()
    {
        ...
        if ($this->showAll || $this->groups['baselineinformation']) {
            $this->addFormatedStringCell(
                '%s (%s)',
                [$this->trans('Bruttoetageareal'), $this->trans('appbundle.bygning.bruttoetageareal.unit')]
            );
            $this->addFormatedStringCell('Varmeværk');
            $this->addFormatedStringCell('%s (%s)', ['CO2-faktor Varme 2009', 'Kg CO2/mWh']);
            $this->addFormatedStringCell(
                '%s (%s)',
                [$this->trans('CO2 Varme 2009'), $this->trans('appbundle.rapport.BaselineCO2Varme.unit')]
            );
            ...
            $this->addFormatedStringCell(
                '%s (%s)',
                ['CO2 El 2009', $this->trans('appbundle.rapport.BaselineCO2El.unit')]
            );
            $this->addFormatedStringCell('%s (%s)', ['CO2-faktor El screeningsdato', 'Kg CO2/mWh']);
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Varmeforbrug GAF (Baseline)', $this->trans('appbundle.rapport.BaselineVarmeGAF.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Varmeforbrug GUF (Baseline)', $this->trans('appbundle.rapport.BaselineVarmeGUF.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Elforbrug (Baseline)', $this->trans('appbundle.rapport.BaselineEl.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Straffeafkøling', $this->trans('appbundle.rapport.BaselineStrafAfkoeling.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Energibudget, varme', $this->trans('appbundle.rapport.energibudgetVarme.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Energibudget, el', $this->trans('appbundle.rapport.energibudgetEl.unit')]
            );
        }
        ...
        if ($this->showAll || $this->groups['besparelsesinformation']) {
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Varmebesparelse GAF', $this->trans('appbundle.rapport.besparelseVarmeGAF.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Varmebesparelse GUF', $this->trans('appbundle.rapport.besparelseVarmeGUF.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Elbesparelse', $this->trans('appbundle.rapport.besparelseEl.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Solcelleproduktion, eget forbrug', $this->trans('appbundle.tiltag.solcelleproduktion.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Solcelleproduktion, salg til nettet år 1', $this->trans('appbundle.tiltag.salgTilNettetAar1.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['CO2-besparelse Varme', $this->trans('appbundle.rapport.besparelseCO2varme.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['CO2-besparelse El', $this->trans('appbundle.rapport.besparelseCO2el.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Samlet CO2-besparelse', $this->trans('appbundle.rapport.besparelseCO2.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Total Entreprisesum', $this->trans('appbundle.rapport.anlaegsinvestering.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Genopretning', $this->trans('appbundle.rapport.genopretning.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Modernisering', $this->trans('appbundle.rapport.modernisering.unit')]
            );
            $this->addFormatedStringCell('%s (%s)', [
                'Aa+ Investering eksl. øvrige omkostninger',
                $this->trans('appbundle.rapport.investeringEksFaellesomkostninger.unit'),
            ]);
            $this->addFormatedStringCell(
                '%s (%s)',
                ['MTM fællesomkostninger', $this->trans('appbundle.rapport.mtmFaellesomkostninger.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Energiscreeningspris', $this->trans('appbundle.rapport.energiscreening.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Implementeringsomkostninger', $this->trans('appbundle.rapport.implementering.unit')]
            );
            $this->addFormatedStringCell('%s (%s)', [
                'Aa+ Investering inkl. øvrige omkostninger',
                $this->trans('appbundle.rapport.investeringInklFaellesomkostninger.unit'),
            ]);
            $this->addFormatedStringCell('%s (%s)', [
                'Intern rente inkl. øvrige omkostninger',
                $this->trans('appbundle.rapport.internRenteInklFaellesomkostninger.unit'),
            ]);
            $this->addFormatedStringCell('%s (%s)', [
                'Nutidsværdi inkl. øvrige omkostninger',
                $this->trans('appbundle.rapport.nutidsvaerdiInklFaellesomkostninger.unit'),
            ]);
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Økonomisk besparelse i år 1', $this->trans('appbundle.rapport.besparelseAarEt.unit')]
            );
        }
        ...
        if ('tiltag' === $this->type) {
            ...
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Varmebesparelse GAF', $this->trans('appbundle.tiltag.varmebesparelseGAF.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Varmebesparelse GUF', $this->trans('appbundle.tiltag.varmebesparelseGUF.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Elbesparelse', $this->trans('appbundle.tiltag.elbesparelse.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Solcelleproduktion, eget forbrug', $this->trans('appbundle.tiltag.solcelleproduktion.unit')]
            ...
            $this->addFormatedStringCell(
                '%s (%s)',
                ['samlet energibesparelse', $this->trans('appbundle.tiltag.samletEnergibesparelse.unit')]
            );
            $this->addFormatedStringCell('%s (%s)', [
                'Besparelse på straffeafkøling',
                $this->trans('appbundle.tiltag.besparelseStrafafkoelingsafgift.unit'),
            ]);
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Besparelse D & V', $this->trans('appbundle.tiltag.besparelseDriftOgVedligeholdelse.unit')]
            );
            $this->addFormatedStringCell('%s (%s)', ['Scrapværdi', $this->trans('appbundle.tiltag.scrapvaerdi.unit')]);
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Reinvestering', $this->trans('appbundle.tiltag.reinvestering.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['CO2-besparelse', $this->trans('appbundle.tiltag.samletCo2besparelse.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Faktisk Entreprisesum', $this->trans('appbundle.tiltag.anlaegsInvestering.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Entreprisesum', $this->trans('appbundle.tiltag.anlaegsInvestering.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Genopretning', $this->trans('appbundle.tiltag.genopretning.unit')]
            );
            $this->addFormatedStringCell('%s (%s)', [
                'Genopretning for implementeringsomkostninger',
                $this->trans('appbundle.tiltag.genopretningForImplementeringsomkostninger.unit'),
            ]);
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Modernisering', $this->trans('appbundle.tiltag.modernisering.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Aa+ investering eksl. øvrige omk.', $this->trans('appbundle.tiltag.aaplusInvestering.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Simpel tilbagebetalingstid', $this->trans('appbundle.tiltag.simpelTilbagebetalingstidAar.unit')]
            );
            $this->addFormatedStringCell(
                '%s (%s)',
                ['Nutidsværdi set over 15 år', $this->trans('appbundle.tiltag.nutidsvaerdiSetOver15AarKr.unit')]
            );
        }
        $this->addRow($this->headerStyle);
    }
    ...
    private function addCell($value, $colspan = 1)
    {
        if (\is_array($value)) {
            ...
            if ($value instanceof \DateTime) {
                ...
                $value = (string) $value;
            } elseif ('string' === \gettype($value) && is_numeric($value)) {
                if ((int) $value === $value) {
                    $value = (int) $value;
                } else {
                    $value = (float) $value;
    ...
    private function writeBygning(Bygning $bygning, Tiltag $tiltag = null, $tiltagIndex = 0)
    {
        ...
        if ($tiltag) {
            ...
            $this->addCell('Special' === $type && $tiltag->getTiltagskategori() ? $tiltag->getTiltagskategori()->getNavn() : '');
    ...
    {
        $this->addCell((int) $value);
    }

    private function addNumberCell($value)
    {
        $this->addCell((float) $value);
    }
}
