...
class Baseline
{
    ...
    public function calculateVarmeForbrugsdataGUFRegAar($forbrugUkorrigeret, $samletVarmeforbrugJuniJuliAugust, $GUFFastsaettesEfterType)
    {
        ...
        if (!isset($samletVarmeforbrugJuniJuliAugust) || GUFFastsaettesEfterType::GUF_ANDEL_I_PROCENT_PBA_ELO_NOEGLETAL === $GUFFastsaettesEfterType) {
     ...
     *
     * @param mixed $forbrugUkorrigeret
     * @param mixed $GUFRegAar
     *
     * @return null|float
     */
     ...
     *
     * @param mixed $GAFRegAar
     * @param mixed $GDNormalAar
     * @param mixed $GDPeriode
     *
     * @return null|float
     */
     ...
     *
     * @param mixed $GUFRegAar
     * @param mixed $varmeForbrugsdataGAFNormal
     *
     * @return null|float
     */
     ...
     *
     * @param mixed $varmeForbrugsdataGennemsnitKlimakorrigeret
     *
     * @return null|float
     */
